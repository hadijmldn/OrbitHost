...
const About = () => (
  ...
  <div className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        <span className="font-extrabold"> GoSting </span>  we're redefining the future of web hosting by combining the power of advanced hosting solutions with the innovative world of cryptocurrency <span className="font-extrabold">Our goal</span> is to provide businesses <span className="font-extrabold"> and individuals </span> with exceptional hosting services while offering <span className="font-extrabold"> the </span> convenience and security of crypto payments.
      </motion.p>
